...
router.put('/edit_book/:nid',edit_book);// we can edit particuler book by bookid 
router.delete('/delate_book/:nid',delete_book);// we can edit particuler book by bookid 
